...
TIER_3_YOUTUBE_PROMPT = """You are an expert in Travel & Experiences content creation. Generate natural YouTube-style search queries (seeds) for the given Tier 2 practice.
...
TIER_3_INSTAGRAM_PROMPT = """You are an expert in Travel & Experiences content creation. Generate natural Instagram-style search queries (seeds) for the given Tier 2 practice.
