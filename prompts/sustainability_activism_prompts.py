...
TIER_3_PROMPT = """You are an expert in Sustainability & Activism content creation. Generate natural YouTube-style search queries (seeds) for the given Tier 2 practice.
